...
cp /mnt/data/events_monitor.service /etc/systemd/system/events_monitor.service
...
systemctl enable events_monitor.service
systemctl start events_monitor.service
